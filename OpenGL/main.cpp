...
{ //     COORDINATES     /        COLORS          /    TexCoord   /        NORMALS       //
	...
	-0.5f, 0.0f, -0.5f,     0.83f, 0.70f, 0.44f,	 0.0f, 5.0f,      1.0f, 0.5f,  0.0f, // Left Side
	-0.5f, 1.0f,  0.5f,     0.83f, 0.70f, 0.44f,	 5.0f, 5.0f,      1.0f, 0.5f,  0.0f, // Left Side
	-0.5f, 1.0f, -0.5f,     0.83f, 0.70f, 0.44f,	 5.0f, 0.0f,      1.0f, 0.5f,  0.0f, // Left Side

	-0.5f, 0.0f, -0.5f,     0.83f, 0.70f, 0.44f,	 0.0f, 0.0f,      0.0f, 0.5f, -1.0f, // Non-facing side
	 0.5f, 0.0f, -0.5f,     0.83f, 0.70f, 0.44f,	 0.0f, 5.0f,      0.0f, 0.5f, -1.0f, // Non-facing side
	-0.5f, 1.0f, -0.5f,     0.83f, 0.70f, 0.44f,	 5.0f, 5.0f,      0.0f, 0.5f, -1.0f, // Non-facing side
	 0.5f, 1.0f, -0.5f,     0.83f, 0.70f, 0.44f,	 5.0f, 0.0f,      0.0f, 0.5f, -1.0f, // Non-facing side

	 0.5f, 0.0f, -0.5f,     0.83f, 0.70f, 0.44f,	 0.0f, 0.0f,      1.0f, 0.5f,  0.0f, // Right side
	 0.5f, 0.0f,  0.5f,     0.83f, 0.70f, 0.44f,	 0.0f, 5.0f,      1.0f, 0.5f,  0.0f, // Right side
	 0.5f, 1.0f, -0.5f,     0.83f, 0.70f, 0.44f,	 5.0f, 5.0f,      1.0f, 0.5f,  0.0f, // Right side
	 0.5f, 1.0f,  0.5f,     0.83f, 0.70f, 0.44f,	 5.0f, 0.0f,      1.0f, 0.5f,  0.0f, // Right side

	 0.5f, 0.0f,  0.5f,     0.83f, 0.70f, 0.44f,	 0.0f, 0.0f,      0.0f, 0.5f,  1.0f, // Facing side
	-0.5f, 0.0f,  0.5f,     0.83f, 0.70f, 0.44f, 	 0.0f, 5.0f,      0.0f, 0.5f,  1.0f, // Facing side
	 0.5f, 1.0f,  0.5f,     0.83f, 0.70f, 0.44f,	 5.0f, 5.0f,      0.0f, 0.5f,  1.0f,  // Facing side
	-0.5f, 1.0f,  0.5f,     0.83f, 0.70f, 0.44f,	 5.0f, 0.0f,      0.0f, 0.5f,  1.0f,  // Facing side
