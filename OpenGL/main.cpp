...
// Indices for Cube vertices order
GLuint CubeIndices[] =
{
	0, 1, 2, // Bottom side
	0, 2, 3, // Bottom side
...
// Indices for lightsource vertices order
GLuint lightIndices[] =
{
	0, 1, 2,
	0, 2, 3,
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Update and exports the camera matrix to the Vertex Shader
		...
		// Bind texture so that is appears in rendering
		brickTex.Bind();
		...
		//Rotation Animation
		// Simple timer for the animation
		...
		// Initialize matrices so they are not the null matrix
